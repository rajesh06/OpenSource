...
R and associated tools (Sweave, knitr, etc) were designed around principles of reproducible research. That is, they are intended to allow another user to reproduce - and more importantly test - the results of the original researcher. That should naturally allow for a report produced in R to comply with _ASOP 41_ - but does it?
...
* Do I really need to __echo__ the R code?
